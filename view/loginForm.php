...
<div class="card" id="cardForm">
	...
	<h1 class="card-text">Connection</h1>
  	...
  	<div class="card-body">
	<form method="post" action="../model/loginCheck.php" name="subcribe" id="subcribe" class="form-horizontal" role="form">
	</div>

		<div class="form-group row">
			<label class="col-sm-4 col-form-label" for="name">Pseudo</label>
			<div class="col-sm-6">
			<input type="text" class="form-control champ required" id="name" name="name" placeholder="Nom/Pseudo" required="required" autofocus="autofocus" />
			</div>
		</div>
		...
		<div class="form-group row">
			<div class="col">
				...
				<button type="reset" id="raz" class="btn btn-primary" value="rafraichir">Rafraîchir</button>
			</div>
		</div>
		</form>
	</div>
