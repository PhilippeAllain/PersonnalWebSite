				...
				<div class="collapse navbar-collapse" id="menuprincipal">
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item active">
							<a class="nav-link" href="img/CV_2020.pdf">Mon C.V. <span class="sr-only"></span></a>
						</li>

						<li class="nav-item">
							<a class="nav-link" href="https://www.linkedin.com/in/philippe-frager-538383108/">Linkedin</a>
						</li>
...
<form method="post" action="php/model/checkForm.php">
	<p>
